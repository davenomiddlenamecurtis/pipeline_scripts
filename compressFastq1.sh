...
INPUTFILES="${ID}_sorted_unique.cleaned.r1.fastq ${ID}_sorted_unique.cleaned.r2.fastq"
...
OUTPUTFILES="${ID}_sorted_unique.cleaned.r1.fastq.nottested.gz ${ID}_sorted_unique.cleaned.r2.fastq"
...
WRITTENFILES="${ID}_sorted_unique.cleaned.r1.fastq.nottested.gz"
