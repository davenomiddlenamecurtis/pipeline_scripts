...
REALIDFILE=$PROJECTDIR/BPgenomes/realSamFilesToMove.txt
export IDFILE=$PROJECTDIR/BPgenomes/samFilesToMove.txt
export FROMFOLDER=$PROJECTDIR/BPgenomes/sam
# export TOFOLDER=/cluster/scratch4/rejudcu_scratch/BPgenomes/sam
export TOFOLDER=/cluster/project99/bipolargenomes_raw/forlab/sam
export PIPELINENAME=moveBPSams

# after this is done the sam files will exist as symbolic links so will not be removed when converted to bams
# may be best to mv them back first
